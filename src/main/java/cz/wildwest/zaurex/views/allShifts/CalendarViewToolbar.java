...
public class CalendarViewToolbar extends MenuBar {
    ...
    public CalendarViewToolbar(FullCalendar calendar, boolean allTimezones, boolean editable, boolean viewChangeable, boolean dateChangeable, boolean settingsAvailable, Consumer<Collection<Entry>> onSamplesCreated, Consumer<Collection<Entry>> onSamplesRemoved, List<CalendarView> customViews) {
