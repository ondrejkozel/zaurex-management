...
public class AboutAppView extends VerticalLayout {
    ...
    public AboutAppView() {
        ...
        add(new Html("<div>"+
                ...
                + "Na každé stránce se nachází jednoduché vysvětlení, co se na dané straně nachází a jak se obsluhuje. Toto vysvětlení se dá spustit buď kliknutím na ikonku otazníku v pravém horním rohu, anebo klávesovou zkratkou <code>Alt&nbsp+&nbspH</code>. Stránky, na které daná osoba nemá přístup, se jí ani v nabídce nezobrazují."
